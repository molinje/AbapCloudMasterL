CLASS zcl_349jm_carga_bib DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_349jm_carga_bib IMPLEMENTATION.

 method if_oo_adt_classrun~main.

"NEW CHANGE

    data: lt_acc_categ type table of z349jm_acc_categ,
          lt_catego    type table of z349jm_catego,
          lt_clientes  type table of z349jm_clientes,
          lt_clnts_lib type table of z349jm_clnts_lib,
          lt_libros    type table of z349jm_libros.
...
******** TABLA1 ********
    ...
    delete from z349jm_acc_categ.
    insert z349jm_acc_categ from table @lt_acc_categ.

    if sy-subrc eq 0.
      out->write( |Acceso Categorias: { sy-dbcnt } registros insertados in z349jm_acc_categ | ).
    endif.
...
******** z349_catego ********
    ...
    "Delete possible entries; insert new entries
    delete from z349jm_catego.
    insert z349jm_catego from table @lt_catego.

    if sy-subrc eq 0.
      out->write( |Categorias: { sy-dbcnt } registros insertados z349jm_catego | ).
    endif.
...
******** z349jm_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from z349jm_clientes.
    insert z349jm_clientes from table @lt_clientes.

    if sy-subrc eq 0.
      out->write( |Clientes: { sy-dbcnt } registros insertados z349jm_clientes | ).
    endif.
...
******** z349jm_clnts_lib
    ...
    "Delete possible entries; insert new entries
    delete from z349jm_clnts_lib.
    insert z349jm_clnts_lib from table @lt_clnts_lib.
...
******** z349jm_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from z349jm_libros.
    insert z349jm_libros from table @lt_libros.

    if sy-subrc eq 0.
      out->write( |Libros: { sy-dbcnt } registros insertados z349jm_libros | ).
    endif.
